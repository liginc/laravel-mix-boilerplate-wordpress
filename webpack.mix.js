...
mix
  ...
  .polyfill()
  .js(`${srcRelativePath}/assets/js/app.js`, `${distRelativePath}/assets/js`)
  .eslint()
  .webpackConfig({
    module: {
      rules: [
  ...
  .webpackConfig({
    plugins: [
      new SVGSpritemapPlugin(`${srcRelativePath}/assets/svg/sprite/*.svg`, {
        output: {
...
if (process.env.NODE_ENV === "production") {
  mix
    ...
    .imagemin(
      ...
      {
        test: (filePath) =>
          !!multimatch(filePath, ["assets/images/**/*"]).length,
